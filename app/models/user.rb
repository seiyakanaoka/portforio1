class User < ApplicationRecord
  ...
  has_many :active_directs, class_name: "Direct", foreign_key: "visitor_id", dependent: :destroy
  has_many :passive_directs, class_name: "Direct", foreign_key: "visited_id", dependent: :destroy
